...
public class HudiRecordCursors
{
            ...
            TypeManager typeManager)
    {
        ...
        // hdfsEnvironment.getConfiguration return CachingJobConf which lost carried Configuration in following usage
    ...
    private static HudiFile getHudiBaseFile(HudiSplit hudiSplit)
    {
        ...
        // fix NPE issue same addressed in https://github.com/prestodb/presto/pull/18222
        // this fix class can be removed once we update to 0.12.1 or 0.11.2
        return hudiSplit.getBaseFile().orElseGet(() -> hudiSplit.getLogFiles().get(0));
    }
}
